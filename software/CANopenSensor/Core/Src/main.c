...
static void MX_GPIO_Init(void) {
	...
	/*Configure GPIO pins : GPIO_Mouvement_Pin GPIO_Vibration_Pin */
	GPIO_InitStruct.Pin = GPIO_Mouvement_Pin | GPIO_Vibration_Pin;
