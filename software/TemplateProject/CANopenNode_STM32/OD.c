...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x6000_mouvement_sensor = 0x00000000,
...
typedef struct {
    ...
    OD_obj_var_t o_6000_mouvement_sensor;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6000_mouvement_sensor = {
        .dataOrig = &OD_PERSIST_COMM.x6000_mouvement_sensor,
        .attribute = ODA_SDO_R | ODA_TPDO | ODA_MB,
        .dataLength = 4
    },
    .o_6001_LED = {
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6000, 0x01, ODT_VAR, &ODObjs.o_6000_mouvement_sensor, NULL},
